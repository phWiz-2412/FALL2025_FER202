...
import ColorPicker from "./components/Exercise3_ColorPicker";
import RegistrationForm from "./components/Exercise4_RegistrationForm";
...
function App() {
  ...
  const exercises = [
    ...
    { id: 3, name: "Exercise 3 - Color Picker" },
    { id: 4, name: "Exercise 4 - Registration Form" },
    { id: 5, name: "Exercise 5 - Profile Form" },
